...
class CostTemplateGenerator:
    ...
    async def generate_cost_template(self) -> str:
        ...
        try:
            ...
            with pd.ExcelWriter(filepath, engine="openpyxl") as writer:
                ...
                variable_costs = [
                    {
                        "Тип расхода": "Упаковка",
                        "Стоимость за единицу (₽)": "",
                        "Описание": "Стоимость упаковки одного товара",
                    },
                    {
                        "Тип расхода": "Логистика внутри города",
                        "Стоимость за единицу (₽)": "",
                        "Описание": "Доставка до склада маркетплейса",
                    },
                    {
                        "Тип расхода": "Брак/возвраты %",
                        "Стоимость за единицу (₽)": "",
                        "Описание": "Процент брака от общих продаж",
                    },
                    {
                        "Тип расхода": "Комиссия эквайринга %",
                        "Стоимость за единицу (₽)": "",
                        "Описание": "Комиссия за платежи",
                    },
                    {
                        "Тип расхода": "Переработка возвратов",
                        "Стоимость за единицу (₽)": "",
                        "Описание": "Стоимость обработки возвращенных товаров",
                    },
                ]
                ...
                fixed_costs = [
                    {
                        "Тип расхода": "Аренда склада",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Ежемесячная аренда складского помещения",
                    },
                    {
                        "Тип расхода": "Зарплата персонала",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Фонд оплаты труда",
                    },
                    {
                        "Тип расхода": "Коммунальные услуги",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Электричество, вода, отопление",
                    },
                    {
                        "Тип расхода": "Интернет и связь",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Интернет, телефония",
                    },
                    {
                        "Тип расхода": "Программное обеспечение",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Подписки на сервисы, CRM",
                    },
                    {
                        "Тип расхода": "Бухгалтерские услуги",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Ведение бухгалтерии",
                    },
                    {
                        "Тип расхода": "Маркетинг и реклама",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Контекстная реклама, SMM",
                    },
                    {
                        "Тип расхода": "Банковские услуги",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Обслуживание счетов",
                    },
                    {
                        "Тип расхода": "Страхование",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Страхование товаров и ответственности",
                    },
                    {
                        "Тип расхода": "Прочие административные",
                        "Сумма в месяц (₽)": "",
                        "Описание": "Канцелярия, хозтовары",
                    },
                ]
    ...
    async def process_filled_template(self, file_path: str) -> dict[str, Any]:
        ...
        try:
            ...
            result = {"sku_costs": {}, "variable_costs": {}, "fixed_costs": {}, "summary": {}}
    ...
    def calculate_unit_profitability(
        self, sales_data: dict[str, Any], cost_data: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        try:
            ...
            total_fixed_monthly = sum(
                item["monthly_cost"] for item in cost_data.get("fixed_costs", {}).values()
            )
