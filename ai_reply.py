...
Текст: "{review_text}"
{'К отзыву приложено фото/видео' if has_media else ''}
...
"""
        ...
        logger.info("Сгенерирован ответ на отзыв через ChatGPT")
...
"""
        ...
        generated_answer = response.choices[0].message.content.strip()
        logger.info("Сгенерирован ответ на вопрос через ChatGPT")
        return generated_answer
